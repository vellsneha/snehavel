...
export const designContentById: Record<string, DesignContent> = {
  ...
  d7: {
    ...
    sections: [
      {
        label: "Challenge",
        title: "Make multi site tower ops scannable",
        body: "Fuel, security, downtime, SLA, power, assets. Managers and techs need the same story, remotely.",
      },
      {
        label: "Process",
        title: "Lo fi before polish",
        body: "We locked the narrative structure before high fidelity. The landing page took several rounds.",
      },
      {
        label: "Exploration",
        title: "Wireframe passes",
        layout: "full",
        screens: [
          { src: pulseLofi, caption: "Lo fi home exploration", alt: "Pulse lo fi home page", frame: "card" },
        ],
      },
      {
        ...
        layout: "full",
        screens: [
          { src: pulseDesktop, caption: "Desktop product view", alt: "Pulse desktop view" },
      ...
      },
      {
        ...
        screens: [
          { src: pulseAndroid, caption: "Android view 2.0", alt: "Pulse Android view", frame: "phone" },
          { src: pulseAndroidAlt, caption: "Android 1.0", alt: "Pulse Android 1.0", frame: "phone" },
        ],
      },
      {
        label: "Outcome",
        title: "Shipped and in active use",
        body: "Same operators on desktop and mobile. Strong feedback from field teams.",
      },
    ],
  },
};
